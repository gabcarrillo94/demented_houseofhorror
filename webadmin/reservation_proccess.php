      ...
      <div class="row">
        <div class="col-md-12">
          <div class="banner text-center">
            <h1 class="wow fadeInDown animated" data-wow-delay=".8s">Thank you for booking with us a unique experience</h1>
            <h2 class="wow fadeInDown animated" data-wow-delay=".6s">Remember to bring your ID on the day to confirm your reservation</h2>
            <a href="http://dementedhaunt.com" class="btn btn-border lg wow fadeInLeft animated" data-wow-delay="1.0s">BACK TO HOME</a>
            <div class="scroll">
          </div>
        </div>
        </div>
