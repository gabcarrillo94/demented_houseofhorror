      ...
      <div class="row">
        <div class="col-md-12">
          <div class="banner text-center">
            <h1 class="wow fadeInDown animated" data-wow-delay=".8s">THANKS FOR CONTACTING US!</h1>
            <h2 class="wow fadeInDown animated" data-wow-delay=".6s">We will contact you asap...</h2>
