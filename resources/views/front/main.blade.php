    ...
    <img src="assets/extras/img-scream.png"/></span>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="banner text-center">
                <h1 class="wow fadeInDown animated" data-wow-delay=".6s">ESCAPE ROOM </h1><br>
     ...
     <!-- Clients Section Start -->
      ...
      <section id="blog">
        <div class="container">
          <div class="row">
            <h2 class="section-title red wow fadeInLeft animated" data-wow-delay=".6s"><span style="font-size:40px;">  Get Your Tickets Now.</span></h2>
              ...
              <form method="post" action="https://www.sandbox.paypal.com/cgi-bin/webscr" target="paypal">
                  ...
                  <div style="margin-top:45px;" class="blog-item">
                    ...
                    <div class="content cn-prices">
                      <a class="title">Adults / Children +10 <span style="font-size:25px; color:#ca0106;"><br>Price: $32.00</span></a><br><br>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 wow fadeInRight animated cn-clear" data-wow-delay="1.8s">
              <div class="buytext" style="margin-top:107px;">
