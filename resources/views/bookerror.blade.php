      ...
      <div class="row">
        <div class="col-md-12">
          <div class="banner text-center">
            <h1 class="wow fadeInDown animated" data-wow-delay=".8s">Error! Sorry, the reservation could not be made, try again!</h1>
            <h2 class="wow fadeInDown animated" data-wow-delay=".6s">We have detected an error when processing the payment.</h2>
